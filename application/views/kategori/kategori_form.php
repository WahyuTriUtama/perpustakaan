        ...
        <div class="col-lg-12">
            ...
            <div class="box">
                <div class="box-title">
                    ...
                    <div class="box-tools">
                        <a href="<?php echo site_url('kategori');?>" class="btn btn-info btn-outline btn-sm" type="button"><span class="fa fa-arrow-left"></span> Kembali</a>
                    </div>
                    <div class="clear"></div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="kategori" id="" placeholder="Kategori" value="<?php echo $kategori; ?>" />
