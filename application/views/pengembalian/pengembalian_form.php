                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="varchar" class="col-sm-4 control-label">Kode Pinjam</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="varchar" class="col-sm-4 control-label">Anggota</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="varchar" class="col-sm-4 control-label">Tgl. Pinjam</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="tgl_pinjam" id="tgl_pinjam" readonly="readonly" value="<?php echo $tgl_pinjam; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="varchar" class="col-sm-4 control-label">Batas Kembali</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="varchar" class="col-sm-4 control-label">Tgl. Kembali</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="petugas" id="petugas" readonly="readonly" value="<?php echo $user->nama; ?>" />
